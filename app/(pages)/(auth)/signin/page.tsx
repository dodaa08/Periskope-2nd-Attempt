  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-50 px-4">
      <div className="w-full max-w-sm bg-white rounded-xl shadow p-8 flex flex-col items-center">
        ...
        {/* Google Button */}
        <button className="w-full cursor-pointer flex items-center justify-center gap-2 border border-gray-200 rounded-md py-2 mb-6 font-medium text-gray-700 hover:bg-gray-100 transition">
        ...
        {/* Email Input */}
        <input type="email" placeholder="Enter your official email address" className="w-full border border-gray-200 rounded-md py-2 px-3 mb-3 focus:outline-none text-black" />
        <input type="password" placeholder="Enter your password" className="w-full border border-gray-200 rounded-md py-2 px-3 mb-3 focus:outline-none text-black" />
        <button className="w-full bg-gray-100 hover:bg-gray-200 cursor-pointer text-gray-700 font-medium rounded-md py-2 mb-2 transition">Continue with Email</button> 
        {/* Terms */}
